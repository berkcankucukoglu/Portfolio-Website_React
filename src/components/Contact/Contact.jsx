    ...
    return (
        <div id="contactsection" className="my-16 sm:my-24">
            ...
            <div className="flex flex-col-reverse md:flex-row md:gap-16">
                <div className="md:flex md:flex-col-reverse px-1 ">
                    <div>
                        {/* MailAddress */}
                        <motion.div
                    ...
                    <div className='mt-5 md:mt-0'>
                        <motion.h1
                            ...
                            initial={{ opacity: 0, x: -25 }}
                            transition={{ duration: 1 }}
                            className="text-lg">Have Questions? Just Ask!
                        </motion.h1>
                        <motion.p
                            whileInView={{ opacity: 1, x: 0 }}
                            initial={{ opacity: 0, x: -25 }}
                ...
                <motion.div
                    ...
                    <form className="px-1 contact-form">
                        ...
                        <div className="flex justify-end">
                            <button
                                type="submit"
                                className="bg-white rounded-full p-4 text-sm text-stone-800 w-full md:w-auto transform transition-transform duration-300 hover:scale-110"
                                onClick={(e) => {
                                    e.preventDefault();
