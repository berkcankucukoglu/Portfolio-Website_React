      ...
      <div className="flex flex-col sm:flex-row sm:gap-5">
        ...
        >
          <FontAwesomeIcon
            ...
            className="text-7xl sm:text-6xl"
          />
          <h3 className="my-2 font-semibold text-2xl">
            {' '}
            {MISSION_VISION[0].title}
          </h3>
        ...
        >
          <FontAwesomeIcon icon={faDna} className="text-7xl sm:text-6xl" />
          <h3 className="my-2 font-semibold text-2xl">
            {MISSION_VISION[2].title}
          </h3>
